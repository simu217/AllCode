...
def extractSignature():
    MainPath="D:\Signature_Search_Project\Demo\\"
        ...
        for singFile in files:
            ...
            if ".txt" in singFile:
                ...
                keywords = ["with kind regards", "acknowledged", "agreed and confirmed", "signed:",
                       ...
                       "agreed by the parties using echosign on the dates stated below", "title:","signature:"]
                directory=SavePath+root.replace("D:\Demo\\","")
                for i in keywords:
                    if str1.find(i) >= 0:
                        try:
